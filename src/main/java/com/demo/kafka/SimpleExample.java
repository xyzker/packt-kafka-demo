...
public class SimpleExample {
	...
	public static void main(String args[]) {
		...
		// seeds.add(args[3]);
		seeds.add("10.110.25.196");
		seeds.add("10.110.25.197");
		seeds.add("10.110.25.198");
	...
	public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port)
		...
		while (a_maxReads > 0) {
			...
			FetchRequest req = new FetchRequestBuilder().clientId(clientName)
					.addFetch(a_topic, a_partition, readOffset, 100000) // Note: this fetchSize of 100000 might need to
